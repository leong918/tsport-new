...
<div class="col-sm-12">
    <div class="card mb-3">
        <div class="card-header"><strong>Topic</strong> </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        {{ html()->label('Title') }}
                        {{ html()->text('title')->placeholder('Enter title')->class('form-control')->required() }}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        {{ html()->label('Status') }}
                        {{ html()->select('status')->options(renderSelect(Topic::STATUS))->class('form-control') }}
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="mb-3">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            var table = $('.comment-table').DataTable({
                ...
                ordering: false,
                ajax: {
                    url: "{!! route('admin.topic.update', ['id' => $model->id]) !!}",
                    data: function(d) {
                        var form = {};
