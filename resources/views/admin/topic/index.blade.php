...
@section('breadcrumb')
    <li class="breadcrumb-item active"><span>Topic</span></li>
@endsection
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Topic</strong>
                                <a href="{{ route('admin.topic.create') }}" class="btn btn-primary permission float-end">
                                    <i class="fa fa-plus"></i>
                                </a>
                            </div>
                            <div class="card-body table-listing table-responsive">
                                <table class="table topic-table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Title</th>
                                            <th>Comment</th>
