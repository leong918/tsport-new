...
<div class="row mb-5">
    <div class="col-md-6">
        <div class="mb-3">
            {{ html()->label('Status') }}
            {{ html()->select('status')->options(renderSelect(Faq::STATUS))->class('form-control')->required() }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
    ...
    <div class="col-md-12">
        <div class="mb-3">
            {{ html()->label('Question') }}
            {{ html()->textarea('question')->value(isset($model) ? $model->question : "")->class('form-control wysiwyg') }}
        </div>
    </div>
    <div class="col-md-12">
        <div class="mb-3">
            {{ html()->label('Answer') }}
            {{ html()->textarea('answer')->value(isset($model) ? $model->answer : "")->class('form-control wysiwyg') }}
        </div>
    </div>
</div>
    ...
    $(document).ready(function() { 
        ...
        $("#faq").submit(function(e) {
            ...
            .then(response => {
                ...
                setTimeout(function(){
                    window.location.replace('/admin/faq/index');
                }, 1000);
            })
            .catch(error => {
                swal.fire({
