    ...
    @slot('subcopy')
        @component('mail::subcopy')
            ...
            <div style="margin: 20px 0px">
                ...
                <p>Thank you for choosing our services! You can check your order by clicking on the following link:<br/> <a href="#" style="color:#aba470">Link</a></p>
                <p>Receipt is attached in the email.</p>
            </div>
            <div>
