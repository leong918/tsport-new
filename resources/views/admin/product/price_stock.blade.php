@if(!isset($model))
    <div class="row productStockRow">
        <div class="col-md-8 col-12 d-flex justify-content-between"> 
            <button type="button" class="btn btn-success" style="width: 45%">Success</button>
            <button type="button" class="btn btn-danger" style="width: 45%">Danger</button>
        </div>
        <div class="col-md-4 col-12">
            <h2 class="text-center">96</h2>
...
<script type="text/javascript">
    ...
    var product_price_count = $('.productStockRow').length - 1;

    $('#add_product_stock').on('click', function() {
        product_price_count++;
    ...
    $('body').on('click', '.btn-remove', function() {
        $(this).parents('.productStockRow').remove();
    })
</script>
@endsection