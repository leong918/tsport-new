...
@section('breadcrumb')
    <li class="breadcrumb-item active"><span>Match</span></li>
@endsection
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Match</strong>
                                <a href="{{ route('admin.match.create') }}" class="btn btn-primary permission float-end">
                                    <i class="fa fa-plus"></i>
                                </a>
                            </div>
                            <div class="card-body table-listing table-responsive">
                                <table class="table match-table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Match Title</th>
                                            <th>Short Content</th>
