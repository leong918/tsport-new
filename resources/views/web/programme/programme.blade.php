                    ...
                    <div class="content-wrapper m-auto">
                        ...
                        <ul class="ul">
                            ...
                            @elseif (app()->getLocale() == 'sc') 
                                <li><p class="p2"><a style="color:black" href="{{ asset('assets/web/assets/pdf/sc/(2024 Version) HTC Application Form(C)_202407.pdf') }}" target="_blank">{!! __('Application Form (not required for existing patient)') !!}</a></p></li>
                            ...
                            @elseif (app()->getLocale() == 'tc')
                                <li><p class="p2"><a style="color:black" href="{{ asset('assets/web/assets/pdf/tc/(2024 Version) HTC Application Form(C)_202407.pdf') }}" target="_blank">{!! __('Application Form (not required for existing patient)') !!}</a></p></li>
