...
<div id="best_seller" class="overflow-x-hidden margin-header">
    <div class="">
        <div class="product-banner">
            <img src="{{asset('assets/web/assets/img/best_seller/bg.png')}}" />
            <div class="product-title-wrapper">
                <div class="product-title">Best Seller</div>
                <div class="product-nav d-flex justify-content-center"><span>Home</span><span>></span><span>Best Seller</span></div>
            </div>
        </div>
    </div>
    <div class="container">
