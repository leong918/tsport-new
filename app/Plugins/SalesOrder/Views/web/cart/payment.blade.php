                        ...
                        <div class="payment-details-wrapper">
                            ...
                            <div class="d-md-flex justify-content-center justify-content-md-start payment-method-wrapper">
                                <div class="payment-method-selector">
                                    <input type="radio" id="option1" name="paymet-method" value="credit_card" checked data-toggle="credit-card-section">
                                    <label for="option1">CREDIT CARD (STRIPE)</label>
                                </div>
                                <div class="payment-method-selector">
                                    <input type="radio" id="option2" name="paymet-method" value="alipay" data-toggle="alipay-section">
                                    <label for="option2">ALIPAY HK</label>
                                </div>
                                <div class="payment-method-selector">
                                    <input type="radio" id="option3" name="paymet-method" value="fps" data-toggle="fps-section">
                                    <label for="option3">DIRECT BANK TRANSFER (FPS)</label>
                                </div>
                            </div>
                            <div class="credit-card-section payment-section">
                            ...
                            <div class="fps-section payment-section d-none">
                                <div class="personal-data">
                                    Your personal data will be used to process your order, 
                                    support your experience throughout this website, and for other purposes described in our <span class="bold-text">"Privacy Policy"</span>
                                </div>
...
<script>
    $(document).ready(function() {
        $('input[name="paymet-method"]').on('change', function() {
            var selected_section = $('input[name="paymet-method"]:checked').data('toggle');
