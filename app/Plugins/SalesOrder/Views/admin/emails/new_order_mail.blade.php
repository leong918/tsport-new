...
@component('mail::layout')
    ...
    <div style="margin: 20px 0px">
        ...
        <p style="font-size:14px;">Thank you for choosing our services! You can check your order by clicking on the following link:<br/> <a href="#" style="color:#aba470">Link</a></p>
