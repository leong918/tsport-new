@component('mail::layout')
    ...
    <div style="margin: 20px 0px; font-size:14px;">
        ...
        <p style="font-size:14px;">Thanks for your order. It’s on-hold until we confirm that payment has been received. In the meantime, here’s a reminder of what you ordered:</p>
        <p style="font-size:14px;">Please WhatsApp +852-54425298 with your Order ID once the payment has been completed.<br/>
        ...
        <div>
            <p><h1 style="color:#aba470">Our bank details</h1></p>
            <div style="margin-bottom:20px">
                <p><h2 style="color:#aba470">Great Fancy Ltd</h2></p>
                <ul>
