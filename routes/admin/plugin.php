...
Route::group(['as' => 'plugin.'], function () {
    ...
    Route::post('plugin/reinstall/{name}', [PluginController::class, 'reinstall'])->name('reinstall');
    Route::post('plugin/uninstall/{id}', [PluginController::class, 'uninstall'])->name('uninstall');
